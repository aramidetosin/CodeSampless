...
for result in results.keys():
    ...
    node_data[result]['router-id'] = data['rpc-reply']['data']['ospf-oper-data']['ospf-state']['ospf-instance'][
        'router-id']
    node_data[result]['area-id'] = \
    data['rpc-reply']['data']['ospf-oper-data']['ospf-state']['ospf-instance']['ospf-area']['area-id']
    for ints in data['rpc-reply']['data']['ospf-oper-data']['ospf-state']['ospf-instance']['ospf-area'][
        'ospf-interface']:
